  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <div style={{ padding: '1rem 1.1rem' }}>
          <p style={s.sectionTitle}>Overall Ranking</p>
...
const s = {
  ...
  adminBtn: { width: '100%', padding: '10px 0', background: 'var(--egk-accent)', color: 'var(--egk-accent-on)', border: 'none', borderRadius: 'var(--egk-radius-sm)', fontWeight: 500, fontSize: 13 },
